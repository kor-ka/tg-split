...
const ToClndr = React.memo(() => {
    ...
    return <Card onClick={onClick} style={{ position: 'fixed', padding: 16, top: 'calc(var(--tg-viewport-stable-height) - 77px)', right: 0, borderRadius: '32px 0 0 32px', marginRight: 0, transition: 'transform ease-in 300ms', transform: `translateX(${splitAvailable ? 0 : 64}px)` }}>🗓</Card>
});
